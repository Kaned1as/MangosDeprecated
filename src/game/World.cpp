...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_configs[CONFIG_OFFHAND_CHECK_AT_SPELL_UNLEARN] = sConfig.GetBoolDefault("OffhandCheckAtSpellUnlearn", true);
...
void World::SetInitialWorldSettings()
{
    ...
    sLog.outString( "Loading comand groups..." );
    objmgr.LoadComandsGroups();
...
void World::ShutdownCancel()
{
    ...
    sLog.outString("Server %s cancelled.",(m_ShutdownMask & SHUTDOWN_MASK_RESTART ? "restart" : "shuttingdown"));
}

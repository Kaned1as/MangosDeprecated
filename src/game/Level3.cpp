...
bool ChatHandler::HandleReloadConfigCommand(const char* /*args*/)
{
    ...
    PSendSysMessage("World config settings reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadAchievementRewardCommand(const char*)
{
    ...
    PSendSysMessage("DB table `achievement_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGossipMenuCommand(const char*)
{
    ...
    PSendSysMessage("DB table `gossip_menu` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGossipMenuOptionCommand(const char*)
{
    ...
    PSendSysMessage("DB table `gossip_menu_option` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGossipScriptsCommand(const char* arg)
{
    ...
    if(*arg!='a')
        PSendSysMessage("DB table `gossip_scripts` reloaded.");
...
bool ChatHandler::HandleReloadLootTemplatesMillingCommand(const char*)
{
    ...
    PSendSysMessage("DB table `milling_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesProspectingCommand(const char*)
{
    ...
    PSendSysMessage("DB table `prospecting_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadLootTemplatesSpellCommand(const char*)
{
    ...
    PSendSysMessage("DB table `spell_loot_template` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadQuestPOICommand(const char*)
{
    ...
    PSendSysMessage("DB table `quest_poi` and `quest_poi_points` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSpellClickSpellsCommand(const char*)
{
    ...
    PSendSysMessage("DB table `npc_spellclick_spells` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSkillDiscoveryTemplateCommand(const char* /*args*/)
{
    ...
    PSendSysMessage("DB table `skill_discovery_template` (recipes discovered at crafting) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadSkillExtraItemTemplateCommand(const char* /*args*/)
{
    ...
    PSendSysMessage("DB table `skill_extra_item_template` (extra item creation when crafting) reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadGameObjectScriptsCommand(const char* arg)
{
    ...
    if(*arg!='a')
        PSendSysMessage("DB table `gameobject_scripts` reloaded.");
...
bool ChatHandler::HandleReloadEventScriptsCommand(const char* arg)
{
    ...
    if(*arg!='a')
        PSendSysMessage("DB table `event_scripts` reloaded.");
...
bool ChatHandler::HandleReloadQuestEndScriptsCommand(const char* arg)
{
    ...
    if(*arg!='a')
        PSendSysMessage("DB table `quest_end_scripts` reloaded.");
...
bool ChatHandler::HandleReloadQuestStartScriptsCommand(const char* arg)
{
    ...
    if(*arg!='a')
        PSendSysMessage("DB table `quest_start_scripts` reloaded.");
...
bool ChatHandler::HandleReloadSpellScriptsCommand(const char* arg)
{
    ...
    if(*arg!='a')
        PSendSysMessage("DB table `spell_scripts` reloaded.");
...
bool ChatHandler::HandleReloadLocalesAchievementRewardCommand(const char*)
{
    ...
    PSendSysMessage("DB table `locales_achievement_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleReloadMailLevelRewardCommand(const char* /*arg*/)
{
    ...
    PSendSysMessage("DB table `mail_level_reward` reloaded.");
    return true;
}
...
bool ChatHandler::HandleBanHelper(BanMode mode, const char* args)
{
    ...
    switch(sWorld.BanAccount(mode, nameOrIP, duration, reason,m_session ? m_session->GetPlayerName() : ""))
    {
        case BAN_SUCCESS:
            ...
            argstr << GM->GetName() << " has just pwned " << nameOrIP.c_str() << " due to " << reason << "! ";
            switch(++GM->m_GMscore)
            {
                case 3: argstr << GM->GetName() << " is on a killing spree!"; break;
                case 6: argstr << GM->GetName() << " is unstoppable!"; break;
                case 9: argstr << GM->GetName() << " is dominating!"; break;
                case 12: argstr << GM->GetName() << " is Wicked Sick!"; break;
                case 15: argstr << GM->GetName() << " is GODLIKE!!!"; break;
                default: 
                    break;
            }
            sWorld.SendWorldText(LANG_SYSTEMMESSAGE,argstr.str().c_str());
            break;

...
pEffect SpellEffects[TOTAL_SPELL_EFFECTS]=
{
    ...
    &Spell::EffectForceCastWithValue,                       //141 SPELL_EFFECT_FORCE_CAST_WITH_VALUE    &Spell::EffectTriggerSpellWithValue,                    //142 SPELL_EFFECT_TRIGGER_SPELL_WITH_VALUE
    ...
    switch(m_spellInfo->SpellFamilyName)
    {
		...
		//megai2: may be i'm crazy
                ...
                if (m_caster->HasAura(52437))
                {
                    ...
                    //megai2: and my mind is tryes to decive me...
...
void Spell::EffectSummonType(SpellEffectIndex eff_idx)
{
    ...
    sLog.outDetail("Prop ID: %u, PropGroup: %u, PropType: %u", prop_id, summon_prop->Group, summon_prop->Type);
    ...
    switch(m_spellInfo->SpellFamilyName)
    {
        ...
        case SPELLFAMILY_DRUID:
        {
            ...
            if(m_spellInfo->SpellFamilyFlags & UI64LIT(0x00000000008800))
            {
                ...
                Unit::AuraList const& mPeriodicDamageAura = unitTarget->GetAurasByType(SPELL_AURA_PERIODIC_DAMAGE);
...
void Spell::DoSummonTotem(SpellEffectIndex eff_idx, uint8 slot_dbc)
{
    ...
    if (modOwner && (m_spellInfo->Id != 51052))
        modOwner->ApplySpellMod(m_spellInfo->Id, SPELLMOD_DURATION, duration);
